...
export default function Home() {
  ...
  // SECURITY: Clear any credentials from URL parameters (after mount)
  useEffect(() => {
    if (!mounted) return;
  ...
  // Redirect to dashboard if authenticated (after mount)
  useEffect(() => {
  ...
  // Render stable content during SSR and initial hydration
  const content = (
    <div className="min-h-screen relative overflow-hidden">
      {/* Modern Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" />
      
      {/* Animated Background Elements - Use CSS animations instead of inline styles */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 -left-32 w-64 h-64 bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-float animation-delay-1000" />
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-gradient-to-r from-cyan-400/20 to-blue-400/20 rounded-full blur-3xl animate-float animation-delay-2000" />
      </div>
      ...
      <div className="flex flex-col lg:flex-row relative z-10 min-h-screen">
        ...
        <div className="flex lg:w-1/2 xl:w-3/5 flex-col justify-center px-6 sm:px-8 md:px-12 xl:px-20 py-8 lg:py-0">
          <div className="max-w-xl">
            ...
            {/* Main Headline */}
            <h2 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              AI-Powered Meeting
            ...
            <div className="space-y-4 mb-8">
              {features.map((feature, index) => (
                <div
                  key={feature.title}
                  className="flex items-center space-x-3 group cursor-pointer hover:translate-x-1 transition-transform"
                >
        ...
        <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 relative order-first lg:order-last">
          <div className="w-full max-w-md">
            ...
            {/* Auth Mode Toggle */}
            <div className="flex p-1 mb-6 bg-gray-100/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg border border-gray-200/50 dark:border-gray-700/50">
              <button
  ...
  // Show loading state only on client after mount
  ...
  // Don't render landing page if authenticated (only after mount)
  if (mounted && isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
        <div className="animate-spin h-8 w-8 border-2 border-blue-500 border-t-transparent rounded-full" />
